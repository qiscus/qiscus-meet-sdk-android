...
package com.qiscus.meet.widget;
...
public class QiscusCircularImageView extends AppCompatImageView {
    ...
    public QiscusCircularImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        borderWidth = a.getDimensionPixelSize(R.styleable.QiscusCircularImageView_qa_civ_border_width, DEFAULT_BORDER_WIDTH);
        borderColor = a.getColor(R.styleable.QiscusCircularImageView_qa_civ_border_color, DEFAULT_BORDER_COLOR);
        borderOverlay = a.getBoolean(R.styleable.QiscusCircularImageView_qa_civ_border_overlay, DEFAULT_BORDER_OVERLAY);
        fillColor = a.getColor(R.styleable.QiscusCircularImageView_qa_civ_fill_color, DEFAULT_FILL_COLOR);
