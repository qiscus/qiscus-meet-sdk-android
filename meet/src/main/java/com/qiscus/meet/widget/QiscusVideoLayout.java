 ...
 */
public class QiscusVideoLayout extends ViewGroup {
    private int xPercent = 0;
    private int yPercent = 0;
    private int widthPercent = 100;
    private int heightPercent = 100;

    public QiscusVideoLayout(Context context) {
        super(context);
    }

    public QiscusVideoLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public QiscusVideoLayout(Context context, AttributeSet attrs, int defStyleAttr) {
